...
int main() {
    ...
    //     auto preset = x264::GetDefaultPreset("high");
    //     param.i_bitdepth = 8;
    ...
    //     // NVIDIA will throw this dumb warning at us every frame, so it's smart to suppress it.
    //     // (and yes, this is because we don't do multithreading stuff, and I won't do it because no)
    //     GLuint id = 131154;
